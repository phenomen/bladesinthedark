...
### Повозка
Вы получаете повозку, двух акоросианских коз и стойло. Второе улучшение добавляет повозке броню и делает её больше. Также козы становятся быстрее и сильнее.
